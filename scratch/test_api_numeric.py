...
# Change cwd to project root so model paths resolve correctly
os.chdir(project_root)

from schemas.prediction_schema import validateContent
from handlers.predict_handler import predictHandler

# Create a sample student dictionary with numeric codes for the columns in the num transformer
student_data = {
    "COD_CARRERA": "10",
    "ANO": 2026,
    "SEMESTRE": 1,
...
# Test 2: Multiple Students (Array)
